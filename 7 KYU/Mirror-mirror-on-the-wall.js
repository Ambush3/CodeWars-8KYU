...
function mirror(data) {
    let sorted = [...data].sort((a, b) => a - b); // sort the array in ascending order and copy it to a new array
    let reversed = [...sorted].reverse(); // reverse the sorted array and copy it to a new array
    reversed.shift(); // remove the first element of the reversed array
    return [...sorted, ...reversed]; // return the sorted array and the reversed array concatenated
}